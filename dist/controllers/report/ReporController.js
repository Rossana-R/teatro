    ...
    HandleTransactionReport(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (category && type) {
                ...
                categoryResult = yield CategoryModel_1.default.GetCategoryById({ id: category });
            ...
            test.forEach(item => {
                ...
                currentFields.push(`${category === null || category === void 0 ? void 0 : category.name} ${item._sum.mount}`);
            });
            do {
