...
class ReportController extends BaseController_1.default {
    ReportForEvent(req, res) {
        ...
        `;
            ...
            doc.fontSize(9);
            const createPath = path_1.default.join(cwd, `/public/docs/${id}.pdf`);
            ...
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    var _a;
                    doc.image(path_1.default.join(cwd, `/public/izquierda.png`), 30, 35, { width: 120 });
                    doc.text(menbrete, 150, 60, { align: "center", width: 300 });
                    doc.image(path_1.default.join(cwd, `/public/derecha.png`), 450, 30, { width: 120 });
                    doc.fontSize(12);
                    ...
                    let nowTop = 440;
                    (_a = evt.cancelationRef) === null || _a === void 0 ? void 0 : _a.cancelationRef.forEach((item) => {
