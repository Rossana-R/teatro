...
class StaticticsTransaction extends BaseModel_1.default {
    ...
    // crea
    create(_a) {
        return __awaiter(this, arguments, void 0, function* ({ num, name }) {
    ...
    // return statictics
    conectOrCreate(_a) {
        return __awaiter(this, arguments, void 0, function* ({ name, num }) {
            const year = this.getYear();
            this.StartPrisma();
            ...
            const create = yield this.create({ name, num });
            return create;
        });
    }
    getForYear(_a) {
    ...
    // incrementa
    update(_a) {
        return __awaiter(this, arguments, void 0, function* ({ name, num, id }) {
            const year = this.getYear();
            const month = this.getMonth();
            this.StartPrisma();
